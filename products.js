const products = {
  ...
  "Sữa & đồ uống": [
    ...
    "Sữa con bò 100% 180ml", "Sữa Su Su Dâu Chai", "Cafe Sài Gòn", "Cafe Trần Quang", "Cafe Phố Bịch",
    "Cafe Vinacafe", "Cafe Phố hộp", "Yến sào có đường", "Yến sào không đường", "Sữa ngôi sao giấy lớn", "Sữa ngôi sao giấy nhỏ"
  ],
  "Nước ngọt & bia": [
